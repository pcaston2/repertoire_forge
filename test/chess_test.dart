...
void main() {
  ...
  test('should work with stockfish moves', () {
    //arrange
    var laMove = "e2e4";
    //act
    var move = Move.parse(laMove);
    //assert
    expect(move, isNotNull);
  }, skip: "not sure why this isn't working, fix later");
  ...
  test('should find a promotion capture to knight', () {
    ...
    expect(results, contains(predicate<NormalMove>((m) => m.toString().contains("g7f8n"))));
  });
}